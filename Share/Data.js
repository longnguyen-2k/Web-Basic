...
//     if (e.keyCode == 13) {
//      var html = $(this).val();
//      var newHTML = "<div class='list_"+i+"' style='margin-top: 30px'><p class='html_"+i+"'>"+html+"</p><div style='display: flex'><div class='delete'><a href='#' class='remove' number='"+i+"'>Xóa</a></div><div class='update' style='margin-left: 30px'><a href='#' class='edit' thutu='"+i+"'>Sửa</a></div><div class='like' style='margin-left: 30px'><a href='#' class='wlike'>Like</a></div></div></div>";
//      $("#list").append(newHTML);
//      $(this).val("");
